...
extension Products {
    ...
    [
        ...
        Products(displayTitle: "Zucchini", cartName: "Zucchini", referenceName: "Summer_Squash", pic: "summer_squash", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Dill Carrots", cartName: "Dill Carrot Jar", referenceName: "Dill_Carrots", pic: "dill_carrots", catagory: productCatagory.valueAdded, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Baba Ganoush", cartName: "Baba Ganoush", referenceName: "Baba_Ganoush", pic: "baba_ganoush", catagory: productCatagory.retail, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Beef Lasagna", cartName: "Beef Lasagana Meal", referenceName: "Beef_Lasagna", pic: "beef_lasagna", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "Beef Sausage", cartName: "Beef Sausage Pack", referenceName: "Beef_Sausage", pic: "beef_sausage", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "Butter Chicken Curry", cartName: "Butter Chicken Curry", referenceName: "Butter_Chicken_Curry", pic: "butter_chicken_curry", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "Cheese", cartName: "Cheese Pack", referenceName: "Cheese", pic: "cheese", catagory: productCatagory.retail, options: customOptions.uniquePrice),
        ...
        Products(displayTitle: "Chocolate Bar", cartName: "Chocolate Bar", referenceName: "Chocolate_Bar", pic: "giddy_yo", catagory: productCatagory.retail, options: customOptions.noOptions),
        //Products(displayTitle: "Cinamon Cream Honey", cartName: "Cinamon Cream Honey Jar", referenceName: "Cinamon_Cream_Honey", pic: "cinamon_cream_honey", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "Coconut Yogurt", cartName: "Coconut Yogurt", referenceName: "Coconut_Yogurt", pic: "coconut_yogurt", catagory: productCatagory.retail, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Date Cookies", cartName: "Date Cookies", referenceName: "Date_Cookies", pic: "date_cookies", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "Falafels", cartName: "Falafel Pack", referenceName: "Falafels", pic: "falafel", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "French Loaf", cartName: "French Loaf", referenceName: "French_Loaf", pic: "french_loaf", catagory: productCatagory.retail, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Honey", cartName: "Honey", referenceName: "Honey", pic: "honey", catagory: productCatagory.retail, options: customOptions.uniqueTypes),
        Products(displayTitle: "Kabsa", cartName: "Kabsa", referenceName: "Kabsa", pic: "kabsa", catagory: productCatagory.retail, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Pickled Cauliflower", cartName: "Pickled Cauliflower Jar", referenceName: "Pickled_Cauliflower", pic: "pickled_cauliflower", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "Samosas", cartName: "Samosas", referenceName: "Samosas", pic: "samosas", catagory: productCatagory.retail, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Turkey Pot Pie", cartName: "Turkey Pot Pie", referenceName: "Turkey_Pot_Pie", pic: "turkey_pot_pie", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "Steak", cartName: "Steak", referenceName: "TBone_Steak", pic: "tbone_steak", catagory: productCatagory.retail, options: customOptions.uniquePrice),
        ...
        Products(displayTitle: "Yalanji", cartName: "Yalanji", referenceName: "Yalanji", pic: "yalanji", catagory: productCatagory.retail, options: customOptions.noOptions)
    ]
}
