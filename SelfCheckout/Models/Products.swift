...
extension Products {
    ...
    [
        ...
        Products(displayTitle: "Coconut Yogurt", cartName: "Coconut Yogurt", referenceName: "Coconut_Yogurt", pic: "coconut_yogurt", catagory: productCatagory.retail, options: customOptions.uniquePrice),
