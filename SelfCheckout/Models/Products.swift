...
extension Products {
    ...
    [
        ...
        Products(displayTitle: "Onions", cartName: "Onion", referenceName: "Onions", searchName: "onions", pic: "onions", catagory: productCatagory.produce, options: customOptions.noOptions),
        Products(displayTitle: "Onion Bag", cartName: "Onion Bag", referenceName: "Onion_Bags", searchName: "onion bag", pic: "onion_bag", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Potatoes", cartName: "Potato Bag", referenceName: "Potatoes", searchName: "potatoes", pic: "potatoes", catagory: productCatagory.produce, options: customOptions.noOptions),
        Products(displayTitle: "Potato Basket", cartName: "Potato Basket", referenceName: "Potato_Basket", searchName: "potato basket", pic: "potato_basket", catagory: productCatagory.produce, options: customOptions.noOptions),
        Products(displayTitle: "Pumpkins", cartName: "Pumpkin", referenceName: "Pumpkins", searchName: "pumpkins", pic: "pumpkins", catagory: productCatagory.produce, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Squash", cartName: "Squash", referenceName: "Squash", searchName: "squash", pic: "winter_squash", catagory: productCatagory.produce, options: customOptions.uniqueTypes),
        ...
        Products(displayTitle: "Garlic Scape Butter", cartName: "Garlic Scape Butter", referenceName: "Garlic_Scape_Butter", searchName: "garlic scape butter", pic: "garlic_scape_butter", catagory: productCatagory.preparedFoods, options: customOptions.noOptions),
        ...
        Products(displayTitle: "Small Granola", cartName: "Small Granola", referenceName: "Small_Granola", searchName: "small granola", pic: "small_granola", catagory: productCatagory.retail, options: customOptions.noOptions),
        Products(displayTitle: "Large Granola", cartName: "Large Granola", referenceName: "Large_Granola", searchName: "large_granola", pic: "large_granola", catagory: productCatagory.retail, options: customOptions.noOptions),
